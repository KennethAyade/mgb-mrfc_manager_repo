...
/**
 * Analyze CMVR compliance using Gemini AI with PDF file directly
 * @param pdfBuffer PDF file buffer
 * @param documentName Name of the document
 * @returns Structured compliance analysis
 */
export const analyzeComplianceWithGeminiPDF = async (
  pdfBuffer: Buffer,
  documentName: string
): Promise<any> => {
  try {
    console.log('🤖 Starting Gemini AI compliance analysis (direct PDF)...');
    console.log(`   - Document: ${documentName}`);
...
Return ONLY the JSON object, no additional text.`;
    ...
    console.error('❌ Gemini AI PDF analysis failed:', error.message);
...
export default {
  ...
  analyzeComplianceWithGeminiPDF
};
